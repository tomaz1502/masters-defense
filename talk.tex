...
% \begin{frame}
%   \frametitle{Classical vs Intuitionistic}
%   \begin{itemize}
%     \item Lean's logical framework is intuitionistic
%     \begin{itemize}
%       \item Only constructive proofs are allowed, it is impossible to prove the law of excluded middle
%     \end{itemize}
%     \vitem SMT solvers' logical framework is classical
%     \begin{itemize}
%       \item We will translate Lean theorems to the unsatisfiability of SMT problems through elimination of double negation, which is not provable constructively
%     \end{itemize}
%     \vitem Solution: introduction of axioms
%     \begin{itemize}
%       \item Lean's \texttt{Classical} module
%     \end{itemize}
%   \end{itemize}
% \end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \vitem Since \texttt{evalTerm I bot} is \texttt{False} for any interpretation \texttt{I}, we can use this to derive:\\ \mintinline{lean}{∀ (I : Interpretation), evalTerm I notModusPonens = False}
    \vitem Finally, this can be used to prove the corresponding theorem stated in Lean's native terms:\\
    \mintinline{lean}{∀ (P Q : Prop), P -> (P -> Q) -> Q}
  \end{itemize}
\end{frame}
